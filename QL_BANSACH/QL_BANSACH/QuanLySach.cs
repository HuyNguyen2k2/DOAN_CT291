...
namespace QL_BANSACH
{
    public partial class QuanLySach : Form
    {
        ...
        private void llabelBack_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        private void txtbFind_TextChanged(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT * FROM SACH, LOAI_SACH WHERE SACH.MALOAI=LOAI_SACH.MALOAI AND (tensach like N'%" + tukhoa + "%' or tentacgia like N'%" + tukhoa + "%')";
